...
# executable_path = './algorithm/lifelong_pibt'

# executable_path = './algorithm/lifelong_traffic_paper'

# executable_path = './algorithm/lifelong_traffic_paper_fw_warehouse'

# executable_path = './algorithm/lifelong_traffic_mdd_float_fw_init'

# executable_path = './algorithm/lifelong_traffic_mdd_float_fw_no_init'

# executable_path = './algorithm/lifelong_traffic_mdd_float_shared'

executable_path = './algorithm/lifelong_traffic_mdd_float_shared_fw_init_o'
...
# map_prefix, simulation_time = 'ost003d', '100'
...
for input_file in os.listdir(input_dir):
    ...
    # any(suffix in input_file for suffix in ['_0_','_1_','_2_','_3_','_4_']) and
    ...
    # if (
    # input_file.startswith(map_prefix) and
    # any(suffix in input_file for suffix in ['_1_','_2_','_3_','_4_','_5_','_6_','_7_','_8_','_9_','_10_','_11_','_12_','_13_','_14_','_15_',
    ...
    # if (
    # input_file.startswith(map_prefix) and
    # any(suffix in input_file for suffix in ['_16_','_17_','_18_','_19_','_20_','_21_','_22_','_23_','_24_']) and
    # input_file.endswith('.json')
    # ):



    # if input_file.startswith(map_prefix) and '_0_' in input_file and input_file.endswith('.json'):
