...
avg_data_6 = extract_and_average_data(output_dir_algorithm_6)
avg_data_7 = extract_and_average_data(output_dir_algorithm_7)
...
team_sizes_6, avg_num_tasks_6 = zip(*avg_data_6) if avg_data_6 else ([], [])
team_sizes_7, avg_num_tasks_7 = zip(*avg_data_7) if avg_data_7 else ([], [])
...
plt.plot(team_sizes_1, avg_num_tasks_1, color='b', marker='o', linestyle='-', label='PTFO')
plt.plot(team_sizes_2, avg_num_tasks_2, color='r', marker='x', linestyle='-', label='PTFO_S')
plt.plot(team_sizes_3, avg_num_tasks_3, color='g', marker='^', linestyle='-', label='TFO')
plt.plot(team_sizes_4, avg_num_tasks_4, color='purple', marker='s', linestyle='-', label='PIBT') 
plt.plot(team_sizes_5, avg_num_tasks_5, color='orange', marker='x', linestyle='-', label='PTFO_S_Re') 
plt.plot(team_sizes_6, avg_num_tasks_6, color='brown', marker='x', linestyle='-', label='PTFO_S_Re_Init') 
plt.plot(team_sizes_7, avg_num_tasks_7, color='black', marker='^', linestyle='-', label='TFO_Re') 
...
# plt.title(f'Number of Agents - Avg Number of Tasks Finished ({map_name})')
